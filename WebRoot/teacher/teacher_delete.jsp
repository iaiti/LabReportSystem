					...
					<div class="post">
							...
							<div class="comments">
								<div class="comment">
									<div class="meta">
										<span><s:property
													value="#teacher.name" />
										<a href="teacher_delete?id=<s:property value='#teacher.id'/>">删除</a> 
						...
						<div class="comment"  align="center">
							...
							<s:if test="#request.page.prePage">
								<a href="teacher_list.action?currentPage=1">首页</a>
								<a
									href="teacher_list.action?currentPage=${page.currentPage -1 }">上一页</a>
							</s:if>
							<s:else>
				首页
				上一页
							...
							<s:if test="#request.page.nextPage">
								<a
									href="teacher_list.action?currentPage=${page.currentPage + 1 }">下一页</a>
								<a href="teacher_list.action?currentPage=${page.totalPage }">尾页</a>
							</s:if>
							<s:else>
				下一页
				尾页
