							...
							<div class="comments">
								<div class="comment">
									<div class="meta">
										...
										<a href="teacherhomework_detail?id=<s:property value='#homework.id'/>">点击查看</a> 
										<a href="teacherhomework_prepareupdate?id=<s:property value='#homework.id'/>">点击修改作业内容</a> 
										<a href="teacherhomework_delete?id=<s:property value='#homework.id'/>">删除</a> 
