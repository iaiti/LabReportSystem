		...
		<div id="container">
			...
			<div id="content">
				<div id="col_left">
					<div class="post">
						<div class="meta"></div>
							<form action="homework/teacherhomework_update" method="post">
						<div class="comments">
							<h2>作业修改</h2> 
							<input  type="hidden" name="id"  value=" ${homework.id}"/>
							标题 <br/><input type="text" name="title" size="80"  value="${homework. title}"></input><br/>
							科目 <br/><input type="text" name="subject" size="80" value="${homework.subject} "></input><br/>
							完成时间 <br/><input type="text" name="lastdate" size="80"  value="${homework. lastdate}"></input><br/>
							<textarea id="myEditor" name="teachercontent">${homework. teachercontent}</textarea>
							<script type="text/javascript">
