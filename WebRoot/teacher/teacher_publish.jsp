		...
		<div id="container">
			...
			<div id="content">
				<div id="col_left">
					<div class="post">
						<div class="meta"></div>
						<form action="homework/homework_publish" method="post">
						<div class="comments">
							<h2>作业发布</h2> 
							<input  type="hidden" name="teacherid"  value=" ${sessionScope.teacher.id}"/>
							标题 <br/><input type="text" name="title" size="80" /><br/>
							科目 <br/><input type="text" name="subject" size="80" /><br/>
							完成时间 <br/><input type="text" name="lastdate" size="80" /><br/>
							<textarea id="myEditor" name="teachercontent"></textarea>
							<script type="text/javascript">
